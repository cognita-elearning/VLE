...
INSERT INTO `profile_fields` VALUES (1,'eLearner LMS User ID','profile_elearner_userid','','eLearner','','textfield',0,0,0,1,0,''),(2,'Ime','profile_name','','Osobni podaci','','textfield',0,1,1,2,0,''),(3,'Prezime','profile_lastname','','Osobni podaci','','textfield',0,1,1,2,0,''),(5,'Location','profile_location','','Osobni podaci','','selection',0,0,0,2,0,''),(6,'Organisation unit','profile_organization_unit','','Osobni podaci','','selection',0,0,0,2,0,'');
