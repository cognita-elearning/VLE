...
--
-- Dumping data for table `quiz_node_properties`
--

LOCK TABLES `quiz_node_properties` WRITE;
/*!40000 ALTER TABLE `quiz_node_properties` DISABLE KEYS */;
INSERT INTO `quiz_node_properties` VALUES (2342,2105,'0',0,1,75,'','',0,1,2,0,0,1,1377468000,1380060000,0,1,0,1,0,0,0,0,1,1,0),(2386,2105,'0',0,1,75,'','',0,1,2,0,0,1,1377468000,1380060000,0,1,0,1,0,0,0,0,1,1,0),(4063,3787,'0',5,1,75,'','',2,1,2,0,0,1,1382392800,1384984800,0,1,0,1,0,0,0,5,1,1,0);
/*!40000 ALTER TABLE `quiz_node_properties` ENABLE KEYS */;
UNLOCK TABLES;
