...
Drupal.behaviors.quizQuestionBrowserBehavior = function(context) {
  ...
  var quizRefreshId2=null;
  var selector = '#edit-browser-table-filters-type'+ notDone;
  selector += ', #edit-browser-table-filters-changed'+ notDone;
  selector += ', #edit-browser-table-filters-term'+ notDone;
  $(selector)
  .addClass(done)
  .change(function(event) {
	clearInterval(quizRefreshId2);
  var quizClicked2 = this;
    $('.quiz-question-browser-row').each(function() {
      $(this).remove();
    });
    $('#browser-pager').remove();
	quizRefreshId2 = setInterval("promijeni()", 1000);
	function promijeni(){
      
      $(quizClicked2).trigger('change');
	  clearInterval(quizRefreshId2);
  ...
  var quizRefreshId;
  selector = '#edit-browser-table-filters-title'+ notDone;
  selector += ', #edit-browser-table-filters-name'+ notDone;
  $(selector)
  .addClass(done)
