...
INSERT INTO `languages` VALUES ('en','English','English',0,1,0,'','','',0,''),('hr','Croatian','Hrvatski',0,1,3,'(((($n%10)==1)&&(($n%100)!=11))?(0):((((($n%10)>=2)&&(($n%10)<=4))&&((($n%100)<10)||(($n%100)>=20)))?(1):2))','','hr',0,'b0bba4cc96ed9d1bdba6af56399e00d8');
