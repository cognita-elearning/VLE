...
--
-- Dumping data for table `quiz_user_settings`
--

LOCK TABLES `quiz_user_settings` WRITE;
/*!40000 ALTER TABLE `quiz_user_settings` DISABLE KEYS */;
/*!40000 ALTER TABLE `quiz_user_settings` ENABLE KEYS */;
UNLOCK TABLES;
