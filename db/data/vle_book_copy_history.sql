...
--
-- Table structure for table `book_copy_history`
--
...
--
-- Dumping data for table `book_copy_history`
--

LOCK TABLES `book_copy_history` WRITE;
/*!40000 ALTER TABLE `book_copy_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `book_copy_history` ENABLE KEYS */;
UNLOCK TABLES;
